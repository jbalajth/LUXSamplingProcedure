...
\hline
Sample Location & Pneumatics & Section & VA & VB & VC & Pressure to Watch \\ \hline
Getter Input & Yes & n/a & CV37 & CV34 & CV35 & PT-C15 \\ \hline
Getter Output & Yes & n/a & CV76 & CV74  & n/a & PT-C20\\ \hline
Detector Return & Yes & n/a & CV11 & CV8 & n/a & PT-C1 \\ \hline
PMT Purge Line & Yes & n/a & CV9 & CV7 & n/a & PT-D41, PT-D4\\ \hline
Recirc Pump Inlet & No & \ref{sec:manualdraw} & CV60 & CV61 & n/a & PT-C15 \\ \hline
To SRV & No & \ref{sec:SRV} & CV90 & CV89 & n/a & PT-S10\\ \hline
Storage Bottles & No & \ref{sec:bottles} & CV90 & CV89 & n/a & PT-S10\\ \hline
Calibration Bottle & No & \ref{sec:calibrate} & SAM\_V14 & SAM\_V13 & n/a & n/a\\ \hline  

\end{tabular}
\caption{Sample ports with their corresponding valves and pressure gauge to watch, along with whether pneumatically controlled VA's have been installed. Additionally, the section number that provides additional instructions for collecting a sample from each port has been indicated in the `Section' column. Refer to this table for valves VA, VB and VC as they depend on the location you will be collecting a sample from.}
\label{Table1}
\end{center}
\end{table}
...
\begin{enumerate}
  ...
  \item If the desired port has pneumatics installed (as noted in Table \ref{Table1}) confirm that VB and VC are locked open. If the selected port does not have pneumatics installed, confirm that VA, VB, and VC are locked closed. If VA, VB, or VC is in an unexpected state, stop and contact the director of operations. 
